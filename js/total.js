...
// price2 は「割引が24ヶ月目まで」のホームルーターの25ヶ月目以降の月額(hikaku の表と同じ)。36ヶ月計算のときだけ使う。
(function (w) {
  "use strict";
  var S = [
    ...
    { id: "sbair", name: "SoftBank Air(代理店NEXT)", cat: "router", price: 4950, price2: 5368, set: { sb: 1100, ymobile: 1650 }, shibari: "あり", href: "https://px.a8.net/svt/ejp?a8mat=4BAH9H+2YKMU2+348K+2N9KIA", aff: true, beacon: "https://www12.a8.net/0.gif?a8mat=4BAH9H+2YKMU2+348K+2N9KIA", note: "24ヶ月目まで4,950円(以後5,368円)。端末代は含めていません" },
    { id: "biglobewimax", name: "BIGLOBE WiMAX +5G", cat: "router", price: 3278, price2: 4928, set: { au: 1100, uq: 1100 }, shibari: "なし", href: "https://px.a8.net/svt/ejp?a8mat=4BAH9H+198ZIY+B4+2BD44I", aff: true, beacon: "https://www16.a8.net/0.gif?a8mat=4BAH9H+198ZIY+B4+2BD44I", note: "4,928円から24ヶ月目まで1,650円引き(3,278円)で計算" },
  ...
  // 戻り値の monthly2 は 25ヶ月目以降の月額(price2 を使ったときだけ 0 以外)
  function calc(s, o) {
    o = o || {};
    ...
    var m2 = 0, base = m * months;
    if (s.cat === "router" && s.price2 && months > 24) { m2 = s.price2; base = m * 24 + m2 * (months - 24); }
    var kouji = 0;
    if (s.cat === "hikari") {
    ...
    return { s: s, monthly: m, monthly2: m2, kouji: kouji, per: per, disc: disc, total: base + FEE + kouji - disc, months: months, lines: lines };
  }
